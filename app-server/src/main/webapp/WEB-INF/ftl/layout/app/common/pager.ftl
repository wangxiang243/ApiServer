...
<ul class="clearfix">
  <#if (pageNo == 1)>
	<li class="disabled">&laquo;&nbsp;上一页</a></li>
  <#else>
	<li><a href="javascript:void(0)" onclick="turnOverPage(${pageNo - 1})">&laquo;&nbsp;上一页</a></li>
  </#if>
<#-- 如果前面页数过多,显示... -->
	<#assign start=1>
	<#if (pageNo > 4)>
...
<#-- 下一页处理 -->
  <#if (pageNo == pageCount)>
	<li class="disabled">下一页&nbsp;&raquo;</li>
  <#else>
